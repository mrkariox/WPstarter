...
function starter_theme_scripts() {
	...
	wp_enqueue_script( 'starter_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'starter_theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_page('Konfigurator szablonu');
...
function langSwitcher(){
	...
	<ul class="lang-bar__switcher">
		<?php 
			$lang_switcher = icl_get_languages("skip_missing=0");
			foreach ($lang_switcher as $switcher):
		?>
		<li <?php echo ($switcher['active'] ? "class='active'" : ""); ?>>
			<a href="<?php echo $switcher['url'] ?>"><?php echo $switcher['code'] ?></a>
		</li>
